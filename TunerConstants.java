...
//Notes: 
//Left bumber -> resets the position 
//Current position - the position it wants to be in (Closed loop) (0 = its on the correct position) (position voltage) (PID Position -> Close loop -> Reference)
//ks is too high -> is what is causing the loud noise (change to 0.1)
//Kp (overshoot) Kd (balance it out) (click on the arrow button to update it on the phoniex tuner) (never change KI)
...
public class TunerConstants {
    ...
    //T0 go to normal 
    //each motor has a sensor (for velcoity purposes)
    ...
    private static final Current kSlipCurrent = Amps.of(120.0); //current limit for drive motor 
    ...
    private static final TalonFXConfiguration steerInitialConfigs = new TalonFXConfiguration()
        .withCurrentLimits(
            new CurrentLimitsConfigs()
                ...
                .withStatorCurrentLimit(Amps.of(60)) //current limit for streer motor 
    ...
    //TYPE IN VALUES HERE (TO CHANGE)
    //Might need to change based on the weight 
    //Team station is blue 1 

    // Front Left
    private static final int kFrontLeftDriveMotorId = 16;
    private static final int kFrontLeftSteerMotorId = 20;
    private static final int kFrontLeftEncoderId = 10;
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(-0.25732421875); //new value for straight backward or forward 
    private static final boolean kFrontLeftSteerMotorInverted = true;
    private static final boolean kFrontLeftEncoderInverted = false;

    private static final Distance kFrontLeftXPos = Inches.of(11.875); //values given from Zuhayr (front left back left )
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(-0.152099609375);
